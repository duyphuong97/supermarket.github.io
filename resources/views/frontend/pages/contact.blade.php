	...
	<section class="bg0 p-t-104 p-b-116" ng-controller="contactController">
		<div class="container">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form name="contactForm" ng-submit="submitContactForm()" novalidate>
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Gởi lời nhắn cho công ty Marketonline
						</h4>
						...
						Chỉ hiển thị khi các validate trong form `contactForm` không hợp lệ => contactForm.$valid = true
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								Trương đại học cần thơ khu hòa an
							</p>
						</div>
					</div>
					...
					<div class="flex-w w-full">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
								Marketonlinelaravel1@gmail.com
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row mt-4">
				...
				<div class="col-md-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14952.998369960571!2d105.60377073695234!3d9.762327113624355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0f1d1e88956ef%3A0xef7a6de6658fee0c!2zxJDhuqFpIEjhu41jIEPhuqduIFRoxqEgS2h1IEjDsmEgQW4!5e0!3m2!1svi!2s!4v1569174042812!5m2!1svi!2s" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
				</div>
			</div>
		</div>
	</section>
